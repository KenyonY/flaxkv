...
def test_basic_operations(db_root):
    ...
    db = create_database("test", root_path=db_root)
...
def test_persistence(db_root):
    ...
    # Reopen and verify
    db2 = get_database("test", root_path=db_root)
...
def test_multiple_databases(db_root):
    ...
    db1 = create_database("db1", root_path=db_root)
    db2 = create_database("db2", root_path=db_root)
